		...
		<div class="navbar-collapse collapse naff">
			<ul class="nav navbar-nav">
				...
				<li><a href="?page=menu_barang"><i class="fas fa-utensils"></i> Produk</a></li>
					<li><a href="?page=login_pelanggan"><i class="fas fa-sign-in-alt"></i> Login Penyewa</a></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="login.php"><i class="fas fa-user"></i> Login Admin</a></li>
			</ul>
		</div>
	</div>
</nav>
			...
			<div class="col-md-3 col-md-pull-9"> 
				...
				<div class="panel panel-color">
					<div class="panel-heading">
						<h3 class="panel-title">Kategori Barang Sewa</h3>
					</div>
					<div class="list-group">
						<a href="" class="list-group-item"><i class="fas fa-utensils"></i></i> Tenda</a>
						<a href="" class="list-group-item"><i class="fas fa-utensils"></i></i> Perlatan Pendakian</a>
						<a href="" class="list-group-item"><i class="fas fa-utensils"></i></i> Perabotan Masak Outdoor</a>
						<a href="" class="list-group-item"><i class="fas fa-utensils"></i></i> Tas Outdoor </a>
					</div>
				</div>
