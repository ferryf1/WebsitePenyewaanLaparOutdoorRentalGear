<center><h3>DATA STATUS PEMBAYARAN (SUDAH TERBAYAR)</h3></center>
      <table class="table table-bordered" id="dataTables-example" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          include 'koneksi.php';
          $no=1;
            $query=mysql_query("SELECT * from tb_transaksi where status1='TERBAYAR' order by tgl_transaksi desc");
